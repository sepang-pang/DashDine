...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long>, RestaurantRepositoryCustom {
    ...
    @Query("select new jpabook.dashdine.dto.response.restaurant.RestaurantForm(r.name, r.tel, r.info, r.openingTime, r.closingTime, r.isOperating, r.minimumPrice, r.category.name, r.address.street, r.address.streetDetail) from Restaurant r where r.user.id = :userId and r.isDeleted = false")
